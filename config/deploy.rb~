...
role :web, "54.228.96.33"  # Your HTTP server, Apache/etc
role :app, "54.228.96.33"  # This may be the same as your `Web` server
role :db,  "54.228.96.33", :primary => true  # This is where Rails migrations will run
